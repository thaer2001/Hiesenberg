...
Route::get('listAllDrugs',[DrugsController::class,'listAllDrugs'])->middleware('verifyApiToken');
Route::post('search',[DrugsController::class,'search'])->middleware('verifyApiToken');
Route::post('listDetails/{id}',[DrugsController::class,'listDetails'])->middleware('verifyApiToken');
